...
def plot_prediction(true, y_pred, trend, seasonality, data):
    ...
    trend_mean, trend_min_interval, trend_max_interval = confidence_interval(trend, 0.05)
    seasonal_mean, seasonal_min_interval, seasonal_max_interval = confidence_interval(seasonality, 0.05)
    ...
    fig.update_layout(height=600, width=1300, title_text="Bitcoin Price Prediction")
